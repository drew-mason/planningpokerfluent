...
PlanningPokerStoryAjax.prototype = Object.extendsObject(AbstractAjaxProcessor, {
    ...
    getSessionStories: function() {
        ...
        try {
            var gr = new GlideRecord('x_1860782_msm_pl_0_session_stories');
    ...
    deleteStory: function() {
        ...
        try {
            ...
            var voteGr = new GlideRecord('x_1860782_msm_pl_0_vote');
    ...
    _getNextSequenceOrder: function(sessionId) {
        var gr = new GlideAggregate('x_1860782_msm_pl_0_session_stories');
        gr.addQuery('session', sessionId);
