...
PlanningPokerVotingAjax.prototype = Object.extendsObject(AbstractAjaxProcessor, {
    ...
    castVote: function() {
        ...
        try {
            ...
            var existingVote = new GlideRecord('x_902080_ppoker_vote');
            ...
            if (existingVote.next()) {
                ...
                var newVote = new GlideRecord('x_902080_ppoker_vote');
                newVote.initialize();
                ...
                var vote = new GlideRecord('x_902080_ppoker_vote');
                vote.initialize();
    ...
    getStoryVotes: function() {
        ...
        try {
            var gr = new GlideRecord('x_902080_ppoker_vote');
