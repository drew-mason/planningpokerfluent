...
export const x_snc_msm_pp_session = Table({
    name: 'x_snc_msm_pp_session',
...
export const x_snc_msm_pp_session_stories = Table({
    name: 'x_snc_msm_pp_session_stories',
    label: 'Session Stories',
    schema: {
        session: ReferenceColumn({
            label: 'Session',
            reference: 'x_snc_msm_pp_session',
            mandatory: true,
        }),
...
//  Votes Table
export const x_snc_msm_pp_vote = Table({
    name: 'x_snc_msm_pp_vote',
    label: 'Planning Vote',
    schema: {
        session: ReferenceColumn({
            label: 'Session',
        ...
        story: ReferenceColumn({
            label: 'Story',
            reference: 'x_snc_msm_pp_session_stories',
            mandatory: true,
        }),
...
export const x_snc_msm_pp_session_participant = Table({
    name: 'x_snc_msm_pp_session_participant',
