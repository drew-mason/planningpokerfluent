...
export function testTableAccess() {
    ...
    try {
        ...
        grTable.addQuery('name', 'x_902080_planpoker_session');
        grTable.query();
        
        if (grTable.next()) {
            gs.info('✅ Table x_902080_planpoker_session exists');
            gs.info('Table label: ' + grTable.label);
            gs.info('Table sys_id: ' + grTable.sys_id);
        } else {
            gs.error('❌ Table x_902080_planpoker_session does not exist');
            return;
        }
        ...
        var testGr = new GlideRecord('x_902080_planpoker_session');
        ...
        if (testId) {
            ...
            testGr = new GlideRecord('x_902080_planpoker_session');
